...
head = head.replace('#gl{display:block;width:100%;height:100%}',
 '#world{position:absolute;left:0;top:0;transform-origin:0 0;will-change:transform}\n#world img{display:block;width:' + str(meta['width']) + 'px;height:' + str(meta['height']) + 'px;pointer-events:none;user-select:none;-webkit-user-drag:none;-webkit-mask-image:linear-gradient(#0000,#000 5%,#000 94%,#0000);mask-image:linear-gradient(#0000,#000 5%,#000 94%,#0000)}\n.mk.tiny.small .dot{width:13px;height:13px;border-width:1.5px}\n.mk.tiny .dot span{display:none}\n.mk.tiny .cap{display:none}\n#world svg{position:absolute;left:0;top:0;pointer-events:none}')
