...
LL = {
    ...
    # Aroa and Rutaki
    "waterline":     (-21.2530, -159.8262),
    "wilsons":       (-21.2560, -159.8248),
    "aroa":          (-21.2585, -159.8235),
    "shipwreck":     (-21.2500, -159.8262),
    # The south: Vaimaanga and Titikaveka
    "wigmores":      (-21.2545, -159.7640),
    "sheraton":      (-21.2745, -159.7710),
    "vaima":         (-21.2735, -159.7690),
    "nustall":       (-21.2790, -159.7720),
    "titikavekacicc":(-21.2775, -159.7625),
    "matutu":        (-21.2765, -159.7620),
    "charlies":      (-21.2775, -159.7590),
    "mairenui":      (-21.2705, -159.7580),
    "stay-titikaveka":(-21.2770, -159.7620),
    "fruits":        (-21.2745, -159.7455),
